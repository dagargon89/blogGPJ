...
import { ArrowLeft, BookOpen, Calendar, Clock, FileText, Film, GalleryHorizontal, Tag } from 'lucide-react';
...
const typeConfig: Record<ContentType, { label: string; icon: React.ElementType; color: string }> = {
    article:     { label: 'Artículo',   icon: BookOpen,          color: 'text-primary bg-primary/10 ring-primary/20' },
    video:       { label: 'Video',       icon: Film,              color: 'text-rose-600 bg-rose-50 ring-rose-200 dark:text-rose-400 dark:bg-rose-950/40 dark:ring-rose-900' },
    infographic: { label: 'Infografía', icon: GalleryHorizontal, color: 'text-amber-600 bg-amber-50 ring-amber-200 dark:text-amber-400 dark:bg-amber-950/40 dark:ring-amber-900' },
    document:    { label: 'Documento',  icon: FileText,           color: 'text-sky-600 bg-sky-50 ring-sky-200 dark:text-sky-400 dark:bg-sky-950/40 dark:ring-sky-900' },
};
    ...
    return (
        <PublicLayout>
            ...
            <div className="mx-auto max-w-3xl px-4 sm:px-6">
                ...
                <div className={post.media.cover ? '-mt-14 relative z-10 pb-2' : 'pt-10'}>
                    <Link
                        href="/blog"
                ...
                <header className="mt-6 mb-10">
                    ...
                    <div className="mb-4 flex flex-wrap items-center gap-2">
                        ...
                        <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium ring-1 ${type.color}`}>
                    ...
                    <div className="mt-6 flex items-center gap-3 border-t border-border pt-5">
                        ...
                        <div>
                            ...
                            <div className="mt-0.5 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-muted-foreground">
                                ...
                                {post.content_type === 'article' && minutes > 0 && (
                                    <span className="flex items-center gap-1">
                ...
                <div className="mb-12">
                    ...
                    {!post.content && !post.media.youtube_id && !post.media.document && (
                ...
                {/* ── Tags ── */}
                {post.tags.length > 0 && (
                    <div className="mb-16 flex flex-wrap items-center gap-2 rounded-xl border border-border bg-muted/30 px-5 py-3.5">
